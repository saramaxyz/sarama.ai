...
prefix: ""
permalink: /uplift.html
title: Uplift | Sarama
description: What does it mean to recognize a dog as a person? Sarama builds instruments that make nonhuman minds legible.
twitterDescription: What does it mean to recognize a dog as a person?
canonical: https://sarama.ai/uplift.html
waveform: true
eyebrow: Uplift Philosophy
heroTitle: "What changes when we stop treating dogs as <em>property</em> and start recognizing them as <strong>persons</strong>?"
lead: Sarama is not building another gadget. It is building instruments that make the minds of the animals closest to us legible.
cta:
...
<blockquote>
  <p>"As people understand consciousness across all beings more deeply, we will see a world where the impulse for authoritarianism and the impulse for suffering is constrained much more deeply."</p>
  <cite>Praful Mathur, Sarama founder</cite>
</blockquote>

## From pidgin to understanding
